<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./application/admin/template/index\index.htm";i:1583310876;s:77:"D:\phpstudy_pro\WWW\www.eyo.com\application\admin\template\public\menubox.htm";i:1571728724;s:74:"D:\phpstudy_pro\WWW\www.eyo.com\application\admin\template\public\left.htm";i:1582973980;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="admincp-header-r">
          <div class="manager">
            ...
            <div class="btn-group pull-left ey-tool">
              ...
              <!-- 小程序 start --> 
              <?php if(is_check_access('Minipro@index') == '1'): ?>
              <!-- <a id="Minipro_theme_index" class="btn btn-default dropdown-toggle" href="javascript:void(0);" onclick="openItem('Minipro|index');" <?php if($web_minipro_switch == -1): ?> style="display: none;" <?php endif; ?> title="可视化小程序">
