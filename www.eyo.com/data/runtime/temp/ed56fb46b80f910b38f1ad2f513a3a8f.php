<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:23:"./template/pc/index.htm";i:1571728724;s:54:"D:\phpstudy_pro\WWW\www.eyo.com\template\pc\header.htm";i:1571728724;s:54:"D:\phpstudy_pro\WWW\www.eyo.com\template\pc\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="bg_gray">
  ...
  'titlelen' => '30',
        ...
        <li><a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>">
          <div><img src="<?php echo $field['litpic']; ?>" alt="<?php echo $field['title']; ?>" height="200"></div>
          <p class="title"><?php echo $field['title']; ?></p>
          </a></li>
       <?php ++$e; $aid = 0; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>   
      </ul>
